    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        <form className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <input className="rounded-md border border-gray-200 px-3 py-2 text-sm" placeholder="Name" />
          <input className="rounded-md border border-gray-200 px-3 py-2 text-sm" placeholder="Phone" />
          <input className="rounded-md border border-gray-200 px-3 py-2 text-sm sm:col-span-2" placeholder="Address" />
